...
@stop
@php
     $form = isset($dados_form) ? $dados_form : [];
     $title_form = isset($form['title_form']) ? $form['title_form'] : [];
    // dd($config);
@endphp
@section('content')
  <!--<p>Selecione os publicadores do seu familia para enviar o relatorio para o secretário</p>-->
  <div class="row">
    @include('admin.financeiro1.config_exibe')
    ...
    @endcan --}}
    <div class="col-md-4">
        @include('admin.financeiro1.form')
    </div>
  ...
  @section('js')
    ...
    @include('admin.financeiro1.js_submit')
  @stop
